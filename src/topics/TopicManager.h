...
public:
	...
	void SetRestUser( const std::string & a_RestUser )
	{
		m_RestUser = a_RestUser;
	}
	void SetRestPassword( const std::string & a_RestPassword )
	{
		m_RestPassword = a_RestPassword;
	}
...
private:
	...
	//! Data
	std::string		m_InstanceId;					// unique ID for this TopicManager
	bool			m_bActive;
	...
	void OnWWWRequest(IWebServer::RequestSP a_spRequest);
